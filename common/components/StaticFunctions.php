...
class StaticFunctions {
    ...
    public static function saveFile($FILE, $POST_ID, $POST_TYPE = 'post',$PREFIX = '')
    {
    ...
    public static function deleteFile( $FILENAME, $POST_ID, $POST_TYPE = 'post' , $PREFIX = NULL)
    {
        $DIR = realpath( dirname( __FILE__ ) ) . '/../../' . Yii::$app->params['uploads_dir'] . '/' . $POST_TYPE . '/' . $POST_ID . '/';
        $DIR = $DIR . $PREFIX . $FILENAME;
